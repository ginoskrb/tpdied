	...
	public agregarCamino() {
		...
		botonAgregar.addActionListener(e -> {
			...
			if(sucursalOrigen.getId() == sucursalDestino.getId()) {
				JOptionPane.showMessageDialog(null, "No se puede crear un camino desde una sucursal a si misma","ERROR",JOptionPane.ERROR_MESSAGE);
			}else {
				cam.createCamino(sucursalOrigen, sucursalDestino, tiempo[0], capMaxima.getValue(), estadoTipo.getSelectedItem()=="Operativo");
				dispose();
			}
